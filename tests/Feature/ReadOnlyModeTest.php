...
const WRITE_TOOL_CLASSES = [
    ...
    'submissions_delete' => SubmissionsDelete::class,
];
...
it('advertises only the thirteen read tools over HTTP in read_only mode', function () {
    ...
    // Exact set equality: ONLY the thirteen read tools remain...
