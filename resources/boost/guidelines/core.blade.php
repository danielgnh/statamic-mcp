...
<code-snippet name="Create guideline files for agents and list page builder blocks without instructions" lang="shell">
...
- Guidance for agents about a page builder block goes in the set's `instructions` in its blueprint or fieldset YAML, never in a custom key on the set: the Control Panel drops unknown set keys when the field's settings are saved. Guidance about whole pages or the site goes in markdown under `resources/mcp/guidelines`. The `statamic-mcp-guidelines` skill covers both.
